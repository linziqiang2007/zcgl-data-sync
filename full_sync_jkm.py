...
class full_sync(object):
    ...
    def getTable(self):
        ...
        # 健康码十一个库
        data_bases = [
                    '10.6.57.196','10.6.57.197','10.6.57.198','10.6.57.199','10.6.57.200','10.6.57.201','10.6.57.202','10.6.57.203','10.6.57.204','10.6.57.205','10.6.57.206']
        # 指定需要同步的表 二维数组
        syncTables = [["gx_zdry_jkm_inbound"],["gx_zdry_jkm_patient"],["gx_zdry_jkm_close"]]
        # syncTables = [["sys_log"],["sys_params"],["sys_user"]]
